...
<html lang="en">
  <head>
    ...
    <title>Delete Profile - Eiser</title>
    <!-- Bootstrap CSS -->
    ...
    <!-- JavaScript -->
    <script src="scripts/delete/validate.js"></script>
          ...
          <div class="row">
            <div class="col-lg-8">
              ...
              >
                ...
                <button name="send" type="submit" class="main_btn">Confirm Deletion</button>
            </form>
        </div>
            </div>
          </div>
            ...
            <div class="form-wrap" id="mc_embed_signup">
              <form target="_blank" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01"
                ...
                <div class="checkout_btn_inner">
                  <a class="main_btn" href="#">Signup</a>
                </div>
                <br>
              </form>
            </div>
