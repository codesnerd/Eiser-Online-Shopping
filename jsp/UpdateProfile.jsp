...
<html lang="en">
  <head>
    ...
    <title>Update Profile - Eiser</title>
    <!-- Bootstrap CSS -->
    ...
    <!-- JavaScript -->
    <script src="scripts/update/validate.js"></script>
      ...
      <div class="banner_inner d-flex align-items-center">
        <div class="container">
            <div style="text-align: center;" class="mb-3 mb-md-0">
              ...
              <p>Update your credentials here!</p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="col-lg-8">
              ...
              >
                ...
                <div class="col-md-12 form-group p_star">
                    ...
                    <br><br>
                    <button name="send" type="submit" class="main_btn">Update</button>
                  </div>
                </form>
            </div>
          </div>
